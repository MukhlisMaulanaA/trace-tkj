@php
  ...
  $discountPercent = (float) ($po->discount_percent ?? 0);
  $discountAmount = (float) ($po->discount_amount ?? 0);
  ...
  $dppEnabled = (bool) ($po->dpp_enabled ?? false);
  $dppAmount = (float) ($po->dpp_amount ?? 0);
  ...
  $ppnAmount = (float) ($po->ppn_amount ?? 0);
